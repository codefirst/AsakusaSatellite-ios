...
extension Message {
    ...
    func html(bodyFontSize: CGFloat = Appearance.messageBodyFontSize, bodyColor: UIColor = Appearance.messageBodyColor) -> String {
        ...
        + "<style>body{font-family: 'Hiragino Kaku Gothic ProN'; font-size: \(bodyFontSize)px; color: \(bodyColorCSS); margin:0; padding:0; background-color: white;} iframe{margin-left:-5px;}</style>"
        + "</head>"
